...
// FIX: Updated to use CardProps to receive 'variant'
...
export const Card: React.FC<CardProps> = ({ 
  children, 
  elevation = 'medium', 
  variant = 'default', // <-- Destructure the variant prop
  className 
}) => {
  return (
    // Pass both elevation and variant down to the styled container
